                ...
                <div class="row sm-gutter">
                    <div class="header-logo">
                        <a href="{{URL::to('/homepage')}}">
                            <img src="{{asset('./public/frontend/images/temp logo.png')}}" alt="" class="header-img"></div>
                        </a>
                    </div>
                    ...
                    <div class="header-menu">
                        <ul class="header-ulist">
                            ...
                            <li class="header-list">
                                <a href="" class="header-list--option">MEMBERSHIP</a>
                            </li>
                            <li class="header-list">
                ...
                <div class="row1 sm-gutter">
                    <div class="footer-logo">
                        <div class="col l-2-4 m-4 c-6">
                            <img src="./public//frontend//images//temp logo.png" alt="" class="footer-img"/>
                        </div>
                    </div>
