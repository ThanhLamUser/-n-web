    ...
    <div class="poster col l-12 m-12 c-12">
      <div class="row sm-gutter poster-img" id="trailer">
        ...
        @foreach($movie_by_id as $key => $movie_pro)
          src="{{ $movie_pro->movie_iframe.'&autoplay=1&mute=1' }}"
          @endforeach
          ...
          <div class="choose-seat--container col l-12 m-4 c-6">
            ...
            <div class="choose-seat--content">
              <div class="choose-seat--row">
                @foreach ($seat_room as $key =>$seat)
                <div onclick="toggleFocusCSS(this), updateStickySingleSeats('seat1')" id="seat1"
                  class="choose-seat--seat norm">{{ $seat->seat_name }}</div>
                @endforeach
              </div>
              <div class="choose-seat--row">
            ...
            <div class="buy-popcorn--content">
              ...
              <div class="col l-3 m-4 c-6">
                <div class="buy-popcorn--single">
                  <img src="{{ URL::to('public/upload/popcorn/'.$popcorndrink-> popcorndrink_img) }}" alt="" class="buy-popcorn--img">
                  ...
                  <div class="buy-popcorn--info">
                    ...
                    <p>{{ number_format($popcorndrink->popcorndrink_price, 0, ',', '.') }}đ</p>
                    {{-- onclick="decrPopOne('popcorn-combo-1'), tempPriceCalc()"
                    onclick="incrPopOne('popcorn-combo-1'), tempPriceCalc()" --}}
                    <div class="buy-popcorn--btn">
                        <div class="minus-btn" onclick="decreaseQuantity('popcorn-combo-{{ $key + 1 }}')">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" />
                          </svg>
                        </div>
                        <input readonly value="0" id="popcorn-combo-{{ $key + 1 }}">
                        <div class="plus-btn" onclick="increaseQuantity('popcorn-combo-{{ $key + 1 }}')">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
