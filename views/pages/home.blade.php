...
<div class="content">
    {{-- <div class="grid wide"> --}}
        <div class="poster col l-12 m-12 c-12" style="padding: 0; padding-right: 5px;">
            <div class="row sm-gutter">
                <img src="./public//frontend//images//poster-img.jpg" alt="" class="poster-img">
                ...
                <div class="poster-desc">
                    ...
                    <div class="poster-desc--interactive">
                        ...
                        <button class="poster-desc--buy--tickets--button" onclick="transfer('buy-ticket')">Buy tickets</button>
                    </div>
            ...
            <div class="poster-desc--chevrons-left">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="poster-desc--chevron--left">
                    <path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"/>
                </svg>
            </div>

            <div class="poster-desc--chevrons-right">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="poster-desc--chevron--right">
                    <path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"/>
                </svg>
            </div>

            <div class="poster-page-num">
                <ul class="poster-page-num--ulist">
                    <li class="poster-page-num--list">
                        <a href="" class="poster-page-num--number"></a>
                    </li>
                    <li class="poster-page-num--list">
                        <a href="" class="poster-page-num--number"></a>
                    </li>
