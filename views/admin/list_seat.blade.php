    ...
    <div class="adm__all-movies col l-9 m-4 c-6">
        ...
        <div class="adm__all-movies--container">
            <table>
                ...
                @foreach ($seat_room as $key => $seat_pro)
                <tr>
                    <?php
                    ...
                    <?php
                        if($seat_pro->seat_status == 1){
                    ?>
                    <a style="text-decoration:none;color:black;font-size:1.4rem" href="{{URL::to('/unactive-seat/'.$seat_pro->seat_id)  }}">SELECTED</a>
                    <?php
                        }
                        else{
                    ?>
                    <a style="text-decoration:none;color:#17992d;font-size:1.4rem" href="{{URL::to('/active-seat/'.$seat_pro->seat_id)  }}"> EMPTY</a>
                    <?php
                        }
                    ?>
                    </span></td>
